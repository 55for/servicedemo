...
import me.mikasa.musicservice.adapter.CommonMusicAdapeter;
...
public class RecentMusicFragment extends BaseFragment
    ...
    protected int setLayoutResId() {
        return R.layout.fragment_recent_music;
    }
    ...
    protected void initView() {
        RecyclerView recyclerView=mRootView.findViewById(R.id.rv_recent);
    ...
    public void onItemClick(int pos) {
        MusicUtil.setShared(Constant.KEY_LIST,Constant.RECENTPLAY);
        playMusic(pos);
    }
