package me.mikasa.musicservice.receiver;
...
import me.mikasa.musicservice.util.NotificationUtil;
import me.mikasa.musicservice.util.UpdateUIThread;
...
public class PlayerManagerReceiver extends BroadcastReceiver {
    ...
    private RemoteViews getRemoteViews(boolean isPaused){
        ...
        int musicId = MusicUtil.getIntShared(Constant.KEY_ID);
        RemoteViews remoteViews=new RemoteViews(mContext.getPackageName(),R.layout.layout_music_remoteviews);
        if (musicId == -1){
